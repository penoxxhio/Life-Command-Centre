  ...
  return (
    ...
    >
      ...
      <motion.div variants={item}>
        <Card 
          className="bg-gradient-to-br from-[#161B22] to-[#0D1117] border-border shadow-lg relative overflow-hidden group cursor-pointer active:scale-[0.98] transition-all"
      ...
      <div className="grid grid-cols-2 gap-3">
        <motion.div variants={item}>
          <Card onClick={() => onNavigate(Tab.NUTRITION)} className="bg-card/50 hover:bg-card transition-colors cursor-pointer active:scale-95">
        ...
        <motion.div variants={item}>
          <Card onClick={() => onNavigate(Tab.FITNESS)} className="bg-card/50 hover:bg-card transition-colors cursor-pointer active:scale-95">
             <div className="flex justify-between items-start mb-3">
      ...
      <motion.div variants={item}>
        <Card title="ENERGY BALANCE" onClick={() => onNavigate(Tab.NUTRITION)} className="cursor-pointer active:scale-[0.99] transition-all">
      ...
      {/* Section 4: Budget */}
      <motion.div variants={item}>
        <Card title="MONTHLY SPEND" onClick={() => onNavigate(Tab.MONEY)} className="cursor-pointer active:scale-[0.99] transition-all">
