...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "h-[44px] min-h-[44px] px-4 rounded font-mono text-sm font-bold flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed";
